...
use crate::application::ports::inbound::alunos::{
    AtualizarAluno, CriarAluno, DeletarAluno, ObterAluno,
};
use crate::application::ports::inbound::matriculas::{
    CriarMatricula, DeletarMatricula, ObterMatricula,
};
use crate::application::ports::inbound::professores::{
    AtualizarProfessor, CriarProfessor, DeletarProfessor, ObterProfessor,
};
use crate::application::ports::inbound::turmas::{
    AtualizarTurma, CriarTurma, DeletarTurma, ObterTurma,
};
